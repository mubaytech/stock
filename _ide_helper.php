...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function setTenant($tenant = null)
        {
                        /** @var \Tenancy\Environment $instance */
         ...
         * @static 
         */ 
        public static function identifyTenant($refresh = false, $contract = null)
        {
                        /** @var \Tenancy\Environment $instance */
                        return $instance->identifyTenant($refresh, $contract);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function setIdentified($identified)
        {
                        /** @var \Tenancy\Environment $instance */
                        return $instance->setIdentified($identified);
        }
                    /**
         * Register a custom macro.
         *
        ...
        public static function macro($name, $macro)
        {
                        \Tenancy\Environment::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \Tenancy\Environment::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \Tenancy\Environment::hasMacro($name);
        }
                    /**
         * 
         *
         * @see \Tenancy\Affects\Connections\Provider::boot()
         * @static 
         */ 
        public static function getTenantConnectionName()
        {
                        return \Tenancy\Environment::getTenantConnectionName();
        }
                    /**
         * 
         *
        ...
        {
                        return \Tenancy\Environment::getTenantConnection();
        }
...
namespace  { 
            ...
            class Tenancy extends \Tenancy\Facades\Tenancy {}
